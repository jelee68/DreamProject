...
/*
	...
	*/
	...
	public String book_modify(HttpServletRequest request) {
		...
		dao.book_modifyDao(request.getParameter("book_code"),request.getParameter("book_name"), 
				request.getParameter("book_author"),request.getParameter("book_date"), 
				request.getParameter("book_pub"),request.getParameter("book_id"));
