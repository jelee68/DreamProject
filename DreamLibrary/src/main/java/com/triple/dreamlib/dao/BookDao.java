...
public interface BookDao {
	...
	//public ArrayList<BookSearchDto> book_result1Dao(String select1, String input1,int maxPageListNum, int minPageListNum);	
	//public ArrayList<BookSearchDto> book_result2Dao(String select1, String input1, String cond01,String select2, String input2);	
	public ArrayList<BookSearchDto> book_result3Dao(String select1, String input1, String cond01,String select2, 
			String input2, String cond02,String select3, String input3,int maxPageListNum, int minPageListNum);
